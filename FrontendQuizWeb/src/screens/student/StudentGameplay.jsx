                    ...
                    <div className="!flex !justify-center !items-end !gap-8 !mb-12">
                        {podiumOrder.map((orderIdx, idx) => {
                            ...
                            return (
                                <div
                                    key={entry.userId}
                                    className={`!flex !flex-col !items-center !relative !transition-all !duration-500 ${idx === 1 ? '!z-10 !scale-110' : '!z-0'
                                        } !animate-slideUp`}
                                    style={{ animationDelay: `${idx * 0.1 + 0.2}s` }}
                                >
                                    <div
                                        className={`!relative !rounded-full !border-4 ${borderColors[idx]} !bg-gray-100 !flex !items-center !justify-center !overflow-hidden !shadow-lg ${idx === 1 ? '!w-28 !h-28' : idx === 0 ? '!w-24 !h-24' : '!w-20 !h-20'
                                            } !animate-popIn`}
                            ...
                            return (
                                ...
                                >
                                    ...
                                    <div>
                                        ...
                                        <span className={`!text-xs !font-semibold !px-2 !py-1 !rounded-full ${correctPercentage >= 80 ? '!bg-green-100 !text-green-700' :
